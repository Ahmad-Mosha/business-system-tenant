    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          // The sidebar's sides are logical (see the container below), so its
          // phone drawer opens from the reading start, not a fixed edge.
          side={side === "left" ? "start" : "end"}
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t("modules")}</SheetTitle>
            <SheetDescription>{t("toggleSidebar")}</SheetDescription>
          </SheetHeader>
