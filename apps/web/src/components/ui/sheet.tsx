...
/**
 * `start` and `end` follow the reading direction: `end` is the right edge in
 * English and the left in Arabic. Positions, borders and slides stay physical
 * underneath, so the logical side is resolved here, once.
 */
